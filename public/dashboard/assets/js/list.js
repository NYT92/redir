    ...
    columns: [
      ...
      },
      {
        ...
        render: (data, type, row) => {
          ...
          <button class="btn btn-primary btn-sm" type="button" style="margin-right: 4px;" onclick="editcard('${data.id}', '${data.original_link}', '${data.key}')" data-bs-target="#modal-1" data-bs-toggle="modal">
